...
our %config = (
  ...
  CPPFLAGS => [ "-DANDROID -D__ANDROID_API__=21 -I/home/nls/.buildozer/android/platform/android-ndk-r19c/sysroot/usr/include/arm-linux-androideabi -I/home/nls/py/android/.buildozer/android/platform/build-armeabi-v7a/build/python-installs/myapp/include/python3.8" ],
  CPPINCLUDES => [  ],
  ...
  LDFLAGS => [ "  -L/home/nls/py/android/.buildozer/android/platform/build-armeabi-v7a/build/libs_collections/myapp/armeabi-v7a" ],
  LDLIBS => [ "-lm" ],
  PERL => "/usr/bin/perl",
  RANLIB => ":",
  RC => "windres",
